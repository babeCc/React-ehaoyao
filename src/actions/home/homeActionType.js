...
export const homeAsync = "HOME_ASYNC_TYPE";

export const activityAsync = "ACTIVITY_ASYNC_TYPE";

//模糊查询

export const goodsKeysAsync = "KEYS_ASYNC_TYPE";

export const seacrhAsync = "SEARCH_ASYNC_TYPE";

export const inputValueAction = "INPUT_VALUE_CHANGE";

export const ticketAsync = "TICKET_ASYNC_TYPE";
